  ...
  <div class="container">
    <div class="topbar">
      ...
      <div class="login" id="loginBox">
        ...
        <input id="docId"  name="username" type="text" placeholder="Correo del doctor" autocomplete="username" autocapitalize="off" autocorrect="off" spellcheck="false">
        <input id="docPwd" name="password" type="password" placeholder="Contraseña" autocomplete="current-password">
        <button id="btnLogin"  type="button" class="btn">Iniciar sesión</button>
        <button id="btnLogout" type="button" class="btn hide">Cerrar sesión</button>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="grid">
        ...
        <div><label>Raza</label><input id="f_raza" type="text" placeholder="Beagle / Criollo…"></div>
        <div><label>Edad</label><input id="f_edad" type="number" min="0" step="1" placeholder="4"></div>
        <div><label>Sexo</label><select id="f_sexo"><option value="">—</option><option>Hembra</option><option>Macho</option></select></div>
        <div><label>Dueño (nombre)</label><input id="f_duenio" type="text" placeholder="Nombre del propietario"></div>
        <div><label>Teléfono</label><input id="f_tel" type="tel" placeholder="+52 81…"></div>
        ...
        <div style="grid-column:1/-1"><label>Historial / notas (Privado)</label><textarea id="f_hist" placeholder="Vacunas, alergias, observaciones…"></textarea></div>
        ...
        <div style="grid-column:1/-1; background:#f0fdf4; padding:12px; border-radius:12px; border:1px solid #bbf7d0; display:flex; align-items:center; gap:10px;">
          ...
          <div>
            <label for="f_contacto_publico" style="font-weight:700; color:#166534; font-size:14px; cursor:pointer;">Mostrar información de contacto públicamente</label>
            <div style="font-size:12px; color:#15803d;">Si se desactiva, el perfil público dirá "Llévenme al refugio" y ocultará el nombre/teléfono.</div>
          </div>
        </div>

        <div style="grid-column:1/-1">
          <label>Notas Públicas (Info de extravío)</label>
          <textarea id="f_notas_publicas" placeholder="Datos seguros para el público. Ej: Vacuna Rabia vigente. Soy amigable. Alérgico al pollo."></textarea>
        </div>
      </div>
